...
def train(model_type='all'):
    ...
    # Train Linear Regression if requested
...
if __name__ == "__main__":
    ...
    parser.add_argument('-linear', action='store_true', help='Train only linear regression model')
    parser.add_argument('-logistic', action='store_true', help='Train only logistic regression model')
    ...
    if args.linear:
        ...
        train('all')  # Default: train both models